...
class HabitStatsConfigActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val savedHabit = getSelectedHabit(this, appWidgetId)
                ...
                try {
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        if (allHabits.isEmpty()) {
                            Toast.makeText(this@HabitStatsConfigActivity, "No habits found", Toast.LENGTH_SHORT).show()
                            return@withContext
                        }
                        ...
                        // Select first if nothing was saved
                    ...
                    withContext(Dispatchers.Main) {
                        progressBar.visibility = View.GONE
                        btnLoad.isEnabled = true
                        Toast.makeText(this@HabitStatsConfigActivity, "Error: ${e.message}", Toast.LENGTH_LONG).show()
                    }
                }
            }
        }
        ...
        btnSave.setOnClickListener {
            ...
            saveSelectedHabit(this, appWidgetId, habit)

            val mgr = AppWidgetManager.getInstance(this)
            HabitStatsWidgetProvider().onUpdate(this, mgr, intArrayOf(appWidgetId))
    ...
    companion object {
        private const val PREFS_NAME = "habitikami_habit_stats_widget"
